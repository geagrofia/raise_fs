...
```{r temp_resultsenv, results = 'asis', out.width="100%"}
...
```{r temp_globenv, results = 'asis', out.width="100%"}
...
```{r i1_leaflet_FAO, results = 'asis', out.width="100%"}
 if ( params$FAOCLASS1 > 0){
   ...
   frameWidget(get(paste("FAO_leaflet_widget_i1"), envir = results_env), height = '500')}
...
```{r i1_leaflet_FAOlimits, results = 'asis', out.width="100%"}
  ...
  # print(str(get(paste("FAO_limits_leaflet_widget_i1")), .GlobalEnv))
  # 
  # cat(paste("\n\n## Interactive Classified Map - FAO Limitations Classes \n\n"))
  # 
  # frameWidget(get(paste("FAO_limits_leaflet_widget_i1"), .GlobalEnv), height = '500')}
...
cat("\n\n\n Local list_rast_clas_FAO_cat:\n\n")
print(list_rast_clas_FAO_cat)


cat("\n\n\n results_env list_rast_clas_FAO_cat:\n\n")
print(get(paste("list_rast_clas_FAO_cat"), envir = results_env))


cat("\n\n\n .GlobalEnv list_rast_clas_FAO_cat:\n\n")
print(get(paste("list_rast_clas_FAO_cat"), .GlobalEnv))
...
plot(get(paste("rast_clas_fao_catLikelihood of Adoption"), .GlobalEnv))
...
for (i in 1:length(get(paste("list_rast_clas_FAO_cat"), .GlobalEnv)))   {
   ...
   tryCatch({
    # Debug print
     cat("\n\n\n ### Processing raster:", names(get(
       paste("list_rast_clas_FAO_cat"), .GlobalEnv
     ))[i], "\n")
     
     cat("\n--\n")
     print(get(paste("list_rast_clas_FAO_cat"), .GlobalEnv)[i])
     cat("\n Local \n")
  ...
  subdiv_criteria_name_i1 <- get(paste("list_rast_clas_FAO_cat"), .GlobalEnv)[i]
