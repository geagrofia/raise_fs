...
```{r i1_initialise01, cache = FALSE, echo=FALSE, message=FALSE, warning=FALSE}
...
<div class="fold o"> 
```{r i1_parameters_location, results='asis'}
...
<div class="fold o"> 
```{r i1_rule_base_graphs, results='asis'}
...
<div class="fold o"> 
```{r i1_rule_base_graphs2, results='asis'}
...
rbstacklabellist3 <- rbnumberlabellist3[rbnumberlist3 %in% rbstacklist3]
...
```{r i1_requirements_themes, results='asis'}
...
```{r i1_requirements_ba01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
```{r i1_requirements_climatic01, echo=FALSE, results='asis', eval=clim_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_climatic02, results='asis', eval=clim_crit_i1}
...
print(paste(n_cba3, "Climatic criteria: "))
  ...
  for (i in seq_len(nrow(df_criteria_ba3))) {
...
print(paste(n_rbba3, "Climatic rule bases:"))
  for (i in seq_len(nrow(df_rulebases_ba3))) {
...
```{r i1_requirements_climatic03, echo=FALSE, results='asis', eval=clim_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_phen_stages01, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i1}
...
<div class="fold o"> 
```{r i1_requirements_phen_stages_static02, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=nonsos_crit_i1}
...
```{r i1_requirements_prec01, echo=FALSE, results='asis', eval=prec_crit_i1 }
...
<div class="fold o">   
```{r i1_requirements_prec02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=prec_crit_i1}
...
#      print(period_name)
      if (sum(df_criteria_ba3a_m[i, 'phen_stage'] == period_name, na.rm = TRUE) == 1) {
        print(paste0("period_name = ", as.character(period_name)))
        crit_rownum <-
          which(df_criteria_ba3a_m$phen_stage == period_name)
        assign(paste0("rast_",df_criteria_ba3a_m[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i, 1]),
               sum(get(
                 paste0("rast_",df_criteria_ba3a_m[crit_rownum, 11], "_rsmp")
               ) * get(
                 paste0("rast_period_m_", df_growth_stages_req_prec[i, 1])
               )))
        print(paste0("rast_", df_criteria_ba3a_m[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i, 1]))
#        plot_raster <-
          plot(get(
            paste0("rast_", df_criteria_ba3a_m[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i, 1])
          ),
...
#        print(plot_raster)
        ...
        new_col <-
          get(paste0("rast_", df_criteria_ba3a_m[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i , 1])) %>% terra::extract(xy) # extract the raster values using xy points
        
        new_col <- new_col[[1]]
        
        df_irm <- dplyr::select(df_irm, -any_of(c(as.character(paste0(df_criteria_ba3a_m[crit_rownum, 3]))))) # remove column if name already exists
        
        df_irm <-
          mutate(df_irm,!!as.character(paste0(df_criteria_ba3a_m[crit_rownum, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm tibble, this needs to be dynamic so uses the !! and := operators
        
        
      } else {
    #    print(sum(df_criteria_ba3a_m[, 'phen_stage'] == period_name, na.rm = TRUE))
      }
    }
...
df_criteria_ba3a_d <-
    ...
    for (i in seq_len(nrow(df_growth_stages_req_prec))) {
        period_name <- as.character(df_growth_stages_req_prec[i, 1])
      print(period_name)
      if (sum(df_criteria_ba3a_d[i, 'phen_stage'] == period_name, na.rm = TRUE) == 1) {
        print(paste0("period_name = ", as.character(period_name)))
        crit_rownum <-
          which(df_criteria_ba3a_d$phen_stage == period_name)
        assign(paste0("rast_", df_criteria_ba3a_d[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i, 1]),
               sum(get(
                 paste0("rast_", df_criteria_ba3a_d[crit_rownum, 11], "_rsmp")
               ) * get(
                 paste0("rast_period_d_", df_growth_stages_req_prec[i, 1])
               )))
        print(paste0("rast_", df_criteria_ba3a_d[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i, 1]))
#        plot_raster <-
          plot(get(
            paste0("rast_", df_criteria_ba3a_d[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i, 1])
          ),
...
#        print(plot_raster)
        ...
        new_col <-
          get(paste0("rast_", df_criteria_ba3a_d[crit_rownum, 11], "_rsmp_", df_growth_stages_req_prec[i , 1])) %>% terra::extract(xy) # extract the raster values using xy points
        
        new_col <- new_col[[1]]
        
        df_irm <- dplyr::select(df_irm, -any_of(c(as.character(paste0(df_criteria_ba3a_d[crit_rownum, 3]))))) # remove column if name already exists
        
        df_irm <-
          mutate(df_irm,!!as.character(paste0(df_criteria_ba3a_d[crit_rownum, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm tibble, this needs to be dynamic so uses the !! and := operators
        
        
      } else {
     #   print(sum(df_criteria_ba3a_d[, 'phen_stage'] == period_name, na.rm = TRUE))
      }
    }

df_criteria_ba3a <- rbind(df_criteria_ba3a_m, df_criteria_ba3a_d)

``` 
</div>

```{r i1_requirements_prec03, echo=FALSE, results='asis', eval=prec_crit_i1 }
...
<div class="fold o">   
```{r i1_requirements_prec04, cache = TRUE, cache.whatever=params$Agg, out.width="100%", fig.show="hold", warning=FALSE, eval=prec_crit_i1}

for (i in seq_len(nrow(df_criteria_ba3a))) {
...
```{r i1_requirements_temp01, echo=FALSE, results='asis', eval=tmp_crit_i1, eval=clim_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_temp02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=temp_crit_i1, eval=clim_crit_i1}
...
df_criteria_ba3b_m <-
  dplyr::filter(df_criteria_ba3,
                grepl("^ba_3b", rulebase_stack) &
                  temp_resolution == "m") # filter temperature criteria

if (nrow(df_criteria_ba3b_m) > 0) {
  #1
  for (i in seq_len(nrow(df_criteria_ba3b_m))) {
    #2
    print(paste("i = ", i))
    print(paste("crit = ", df_criteria_ba3b_m[i, 4]))
    for (j in seq_len(nrow(df_growth_stages_req_temp))) {
      ...
      if (sum(df_criteria_ba3b_m[i, 'phen_stage'] == period_name, na.rm = TRUE) == 1) {
        #4
        if (df_criteria_ba3b_m[i, 13] == "mean") {
          #5
          print("mean")
          assign(
            paste0(
              "rast_",
              df_criteria_ba3b_m[i, 11],
              "_rsmp_",
              df_growth_stages_req_temp[j, 1]
            ),
            (sum(get(
              paste0("rast_", df_criteria_ba3b_m[i, 11], "_rsmp")
            ) * get(
          ...
          #-5 5a
          if (df_criteria_ba3b_m[i, 13] == "min") {
            #6
            print("min")
            assign(
              paste0(
            ...
            #-6 6a
            if (df_criteria_ba3b_m[i, 13] == "max") {
              #7
              print("max")
                          assign(
              paste0(
        ...
        new_col <-  get(paste0( "rast_", df_criteria_ba3b_m[i, 11],
            "_rsmp_",
            df_growth_stages_req_temp[j , 1]
        ...
        df_irm <-  dplyr::select(df_irm, -any_of(c(as.character(            paste0(df_criteria_ba3b_m[i, 3]))))) # remove column if name already exists
        
        df_irm <- mutate(df_irm,!!as.character(paste0(df_criteria_ba3b_m[i, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm tibble, this needs to be dynamic so uses the !! and := operators
      } #-4
    }
  }
}
...
if (nrow(df_criteria_ba3b_d) > 0) {
  #1
  for (i in seq_len(nrow(df_criteria_ba3b_d))) {
    #2
    print(paste("i = ", i))
    print(paste("crit = ", df_criteria_ba3b_d[i, 4]))
    for (j in seq_len(nrow(df_growth_stages_req_temp))) {
      #3
      print(paste("j = ", j))
      period_name <- as.character(df_growth_stages_req_temp[j, 1])
      ...
      if (sum(df_criteria_ba3b_d[i, 'phen_stage'] == period_name, na.rm = TRUE) == 1) {
        #4
        if (df_criteria_ba3b_d[i, 13] == "mean") {
          #5
          print("mean")
          assign(
            paste0(
              "rast_",
              df_criteria_ba3b_d[i, 11],
              "_rsmp_",
              df_growth_stages_req_temp[j, 1]
            ),
            (sum(get(
              paste0("rast_", df_criteria_ba3b_d[i, 11], "_rsmp")
            ) * get(
          ...
          #-5 5a
          if (df_criteria_ba3b_d[i, 13] == "min") {
            #6
            print("min")
            assign(
              paste0(
            ...
            #-6 6a
            if (df_criteria_ba3b_d[i, 13] == "max") {
              #7
              print("max")
                          assign(
              paste0(
        ...
        new_col <-  get(paste0( "rast_", df_criteria_ba3b_d[i, 11],
            "_rsmp_",
            df_growth_stages_req_temp[j , 1]
          )) %>% terra::extract(xy) # extract the raster values using xy points
        ...
        df_irm <-  dplyr::select(df_irm, -any_of(c(as.character(            paste0(df_criteria_ba3b_d[i, 3]))))) # remove column if name already exists
        
        df_irm <- mutate(df_irm,!!as.character(paste0(df_criteria_ba3b_d[i, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm tibble, this needs to be dynamic so uses the !! and := operators
      } #-4
    }
  }
}
...
```{r i1_requirements_temp03, echo=FALSE, results='asis', eval=tmp_crit_i1, eval=clim_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_temp04, cache = TRUE, cache.whatever=params$Agg, out.width="100%", fig.show="hold", warning=FALSE, eval=tmp_crit_i1, eval=clim_crit_i1}

for (i in seq_len(nrow(df_criteria_ba3b))) {
...
```{r i1_requirements_soilp01, echo=FALSE, results='asis', eval=soil_p_crit_i1}
...
```{r i1_requirements_soilp02, results='asis', warning=FALSE, eval=soil_p_crit_i1}
...
cat(paste(n_cba2c, "Soil physical properties rule bases:\n\n"))
    for (i in seq_len(nrow(df_criteria_ba2c))) {
...
```{r i1_requirements_soilp03, echo=FALSE, results='asis', eval=soil_p_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_soilp04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_p_crit_i1}
...
```{r i1_requirements_soilp05, echo=FALSE, results='asis', eval=soil_p_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_soilp06, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_p_crit_i1}
...
```{r i1_requirements_soilf01, echo=FALSE, results='asis', eval=soil_f_crit_i1}
...
```{r i1_requirements_soilf02, results='asis', warning=FALSE, eval=soil_f_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_soilf03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_f_crit_i1}

    for (i in seq_len(nrow(df_criteria_ba2d))) {
  new_col <-
...
```{r i1_requirements_soilf04, echo=FALSE, results='asis', eval=soil_f_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_soilf05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_f_crit_i1}
...
```{r i1_requirements_lscape01, echo=FALSE, results='asis', eval=lscape_crit_i1}
...
```{r i1_requirements_lscape02, results='asis', warning=FALSE, eval=lscape_crit_i1}
...
cat(paste(n_cba2e, "Landscape rule bases:\n\n"))
    for (i in seq_len(nrow(df_criteria_ba2e))) {
...
<div class="fold o">   
```{r i1_requirements_lscape03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lscape_crit_i1}
...
```{r i1_requirements_lscape04, echo=FALSE, results='asis', eval=lscape_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_lscape05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lscape_crit_i1}
...
```{r i1_requirements_agland01, echo=FALSE, results='asis', eval=land_crit_i1}

cat("### Agricultural Land requirements")

```

```{r i1_requirements_agland02, results='asis', warning=FALSE, eval=land_crit_i1}
...
cat(paste(n_cba2a, "Agricultural Land rule bases:\n\n"))
    for (i in seq_len(nrow(df_criteria_ba2a))) {
...
<div class="fold o">   
```{r i1_requirements_agland03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=land_crit_i1}
...
```{r i1_requirements_agland04, echo=FALSE, results='asis', eval=land_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_agland05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=land_crit_i1}
...
```{r i1_requirements_sef01, echo=FALSE, results='asis', eval=sef_crit_i1}
...
```{r i1_requirements_market_access01, echo=FALSE, results='asis', eval=mktaccess_crit_i1}

cat("### Market Access requirements")

```

```{r i1_requirements_market_access02, results='asis', warning=FALSE, eval=mktaccess_crit_i1}
...
cat(paste(n_cse2b, "Market Access rule bases: \n\n"))
    for (i in seq_len(nrow(df_criteria_se2b))) {
...
<div class="fold o">   
```{r i1_requirements_market_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=mktaccess_crit_i1}
...
```{r i1_requirements_market_access04, echo=FALSE, results='asis', eval=mktaccess_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_market_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=mktaccess_crit_i1}
...
```{r i1_requirements_inputs_access01, echo=FALSE, results='asis', eval=inpaccess_crit_i1}

cat("### Inputs Access requirements")

```

```{r i1_requirements_inputs_access02, results='asis', warning=FALSE, eval=inpaccess_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se3b))) {
...
<div class="fold o">   
```{r i1_requirements_inputs_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=inpaccess_crit_i1}
...
```{r i1_requirements_inputs_access04, echo=FALSE, results='asis', eval=inpaccess_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_inputs_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=inpaccess_crit_i1}
...
```{r i1_requirements_extension_access01, echo=FALSE, results='asis', eval=extaccess_crit_i1}
...
```{r i1_requirements_extension_access02, results='asis', warning=FALSE, eval=extaccess_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se4a))) {
...
<div class="fold o">   
```{r i1_requirements_extension_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=extaccess_crit_i1}
...
```{r i1_requirements_extension_access04, echo=FALSE, results='asis', eval=extaccess_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_extension_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=extaccess_crit_i1}
...
```{r i1_requirements_labour_access01, echo=FALSE, results='asis', eval=lab_crit_i1}

cat("### Labour requirements")

```

```{r i1_requirements_labour_access02, results='asis', warning=FALSE, eval=lab_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se4b))) {
...
<div class="fold o">   
```{r i1_requirements_labour_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lab_crit_i1}
...
```{r i1_requirements_labour_access04, echo=FALSE, results='asis', eval=lab_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_labour_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lab_crit_i1}
...
```{r i1_requirements_fp_access01, echo=FALSE, results='asis', eval=fp_crit_i1}
...
```{r i1_requirements_fp_access02, results='asis', warning=FALSE, eval=fp_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se4c))) {
...
<div class="fold o">   
```{r i1_requirements_fp_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=fp_crit_i1}
...
```{r i1_requirements_fp_access04, echo=FALSE, results='asis', eval=fp_crit_i1}
...
<div class="fold o">   
```{r i1_requirements_fp_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=fp_crit_i1}
...
```{r i1_rulebases_ba01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
```{r i1_rulebases_land01, echo=FALSE, results='asis', eval=land_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_land02, cache = TRUE, warning=FALSE, eval=land_crit_i1}
...
```{r i1_rulebases_clim01, echo=FALSE, results='asis', eval=clim_crit_i1}

cat("### Climatic rule bases")
```

```{r i1_rulebases_prec01, echo=FALSE, results='asis', eval=prec_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_prec02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=prec_crit_i1}
...
```{r i1_rulebases_tmp01, echo=FALSE, results='asis', eval=tmp_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_tmp02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=tmp_crit_i1}
...
for (i in seq_len(nrow(df_criteria_ba3b))) {
  if (!is.na(df_criteria_ba3b[i, 18])) {
    ...
    prop_levels <-
      c(as.character(df_criteria_ba3b[i, 19]),
        as.character(df_criteria_ba3b[i, 20]))  %>% unique()
...
```{r i1_rulebases_clim02, echo=FALSE, results='asis', eval=clim_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_clim03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=prec_crit_i1, eval=tmp_crit_i1}
...
for (i in seq_len(nrow(df_criteria_ba2b))) {
...
```{r i1_rulebases_soilp01, echo=FALSE, results='asis', eval=soil_p_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_soilp02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=soil_p_crit_i1}
...
```{r i1_rulebases_soilf01, echo=FALSE, results='asis', eval=soil_f_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_soilf02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=soil_f_crit_i1}
...
```{r i1_rulebases_lscape01, echo=FALSE, results='asis', eval=lscape_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_lscape02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=lscape_crit_i1}
...
```{r i1_rulebases_ba02, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_ba03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=ba_crit_i1}
...
for (i in seq_len(nrow(df_criteria_ba1))) {
...
```{r i1_rulebases_ba_export01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o">
```{r i1_rulebases_ba_export02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=ba_crit_i1}
...
```{r i1_rulebases_sef01, echo=FALSE, results='asis', eval=sef_crit_i1}
...
```{r i1_rulebases_extension_access01, echo=FALSE, results='asis', eval=extaccess_crit_i1}
...
```{r i1_rulebases_extension_access02, echo=FALSE, results='asis', eval=extaccess_crit_i1}
...
```{r i1_rulebases_extension_access03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=extaccess_crit_i1}
...
```{r i1_rulebases_extension_access04, echo=FALSE, results='asis', eval=extaccess_crit_i1}
...
```{r i1_rulebases_extension_access05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=extaccess_crit_i1}
...
```{r i1_rulebases_extension_access06, echo=FALSE, results='asis', eval=extaccess_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_extension_access07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=extaccess_crit_i1}
...
```{r i1_rulebases_labour_access01, echo=FALSE, results='asis', eval=lab_crit_i1}
...
```{r i1_rulebases_labour_access02, echo=FALSE, results='asis', eval=lab_crit_i1}
...
```{r i1_rulebases_labour_access03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=lab_crit_i1}
...
```{r i1_rulebases_labour_access04, echo=FALSE, results='asis', eval=lab_crit_i1}
...
```{r i1_rulebases_labour_access05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=lab_crit_i1}
...
```{r i1_rulebases_labour_access06, echo=FALSE, results='asis', eval=lab_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_labour_access07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=lab_crit_i1}
...
```{r i1_rulebases_fp_access01, echo=FALSE, results='asis', eval=fp_crit_i1}
...
```{r i1_rulebases_fp_access02, echo=FALSE, results='asis', eval=fp_crit_i1}
...
```{r i1_rulebases_fp_access03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fp_crit_i1}
...
```{r i1_rulebases_fp_access04, echo=FALSE, results='asis', eval=fp_crit_i1}
...
```{r i1_rulebases_fp_access05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fp_crit_i1}
...
```{r i1_rulebases_fp_access06, echo=FALSE, results='asis', eval=fp_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_fp_access07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=fp_crit_i1}
...
```{r i1_rulebases_farm_inputs01, echo=FALSE, results='asis', eval=inpaccess_crit_i1}
...
```{r i1_rulebases_farm_inputs02 , cache = TRUE, cache.whatever=params$Agg, results='asis', eval=inpaccess_crit_i1}
...
```{r i1_rulebases_farm_inputs03, echo=FALSE, results='asis', eval=inpaccess_crit_i1}
...
```{r i1_rulebases_farm_inputs04, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=inpaccess_crit_i1}
...
```{r i1_rulebases_farm_inputs05, echo=FALSE, results='asis', eval=inpaccess_crit_i1}
...
```{r i1_rulebases_farm_inputs06, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=inpaccess_crit_i1}
...
```{r i1_rulebases_farm_inputs07, echo=FALSE, results='asis', eval=inpaccess_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_farm_inputs08, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=inpaccess_crit_i1}

if (inpaccess_crit_i1 == 1) {
...
```{r i1_rulebases_management01, echo=FALSE, results='asis', eval=management_crit_i1}
...
```{r i1_rulebases_management02, results='asis', warning=FALSE, eval=management_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se3a))) {
  cat(
    paste0(
      "\n",
...
```{r i1_rulebases_management03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=management_crit_i1}
...
```{r i1_rulebases_management04, echo=FALSE, results='asis', eval=management_crit_i1}
...
```{r i1_rulebases_management05, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=management_crit_i1}
...
```{r i1_rulebases_management06, echo=FALSE, results='asis', eval=fp_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_management07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=management_crit_i1}
...
```{r i1_rulebases_fpf01, echo=FALSE, results='asis', eval=fpf_crit_i1}
...
```{r i1_rulebases_fpf02, results='asis', warning=FALSE, eval=fpf_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se2a))) {
  cat(
    paste0(
      "\n",
...
```{r i1_rulebases_fpf03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fpf_crit_i1}
...
```{r i1_rulebases_fpf04, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fpf_crit_i1}
...
```{r i1_rulebases_fpf05, echo=FALSE, results='asis', eval=fpf_crit_i1}
...
```{r i1_rulebases_fpf06, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=fpf_crit_i1}
...
```{r i1_rulebases_fpf07, echo=FALSE, results='asis', eval=fpf_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_fpf08, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=fpf_crit_i1}
...
```{r i1_rulebases_market_access01, echo=FALSE, results='asis', eval=mktaccess_crit_i1}
...
```{r i1_rulebases_market_access02, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=mktaccess_crit_i1}
...
```{r i1_rulebases_market_access03, echo=FALSE, results='asis', eval=mktaccess_crit_i1}
...
```{r i1_rulebases_market_access04, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=mktaccess_crit_i1}
...
```{r i1_rulebases_market_access05, echo=FALSE, results='asis', eval=mktaccess_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_market_access06, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=mktaccess_crit_i1}
...
```{r i1_rulebases_sef02, echo=FALSE, results='asis', eval=sef_crit_i1}
...
```{r i1_rulebases_sef03, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=sef_crit_i1}
...
for (i in seq_len(nrow(df_criteria_se1))) {
  cat(
    paste0(
      "\n",
      df_criteria_se1[i, 3],
...
```{r i1_rulebases_sef04, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=sef_crit_i1}
...
```{r i1_rulebases_sef05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=sef_crit_i1}
...
```{r i1_rulebases_sef06, echo=FALSE, results='asis', eval=sef_crit_i1}
...
```{r i1_rulebases_sef07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=sef_crit_i1}
...
```{r i1_rulebases_sef08, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_sef09, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=sef_crit_i1}
...
```{r i1_rulebases_sef_score01, echo=FALSE, results='asis', eval=sef_crit_i1, eval=adop_crit_i1}
...
<div class="fold o">
```{r i1_rulebases_sef_score02, echo=FALSE, results='asis', eval=sef_crit_i1, eval=adop_crit_i1}
...
```{r i1_rulebases_se_export01, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o">
```{r i1_rulebases_se_export02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=sef_crit_i1}
...
```{r i1_rulebases_adoption01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_adoption02, results='asis', warning=FALSE, eval=adop_crit_i1}
...
for (i in seq_len(nrow(df_criteria_0))) {
  cat(paste0(
    "\n",
    df_criteria_0[i, 3],
    " (",
...
```{r i1_rulebases_adoption03, echo=FALSE, results='asis', eval=adop_crit_i1}

cat("Rule base ba_1 has the following conclusions:")

```

```{r i1_rulebases_adoption04, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=adop_crit_i1}
...
```{r i1_rulebases_adoption05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=adop_crit_i1}
...
```{r i1_rulebases_adoption06, echo=FALSE, results='asis', eval=adop_crit_i1}
...
```{r i1_rulebases_adoption07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=adop_crit_i1}
...
```{r i1_rulebases_adoption08, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_rulebases_adoption09, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=adop_crit_i1}
...
```{r i1_rulebases_adop_export01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o">
```{r i1_rulebases_adop_export02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=adop_crit_i1}
...
```{r i1_classified_adop_membership_maps01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps02 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i1}
# idem + overlay triangulation adoption points

vect_adop_tri <- vect_triangulation %>%
    mutate(
        adopclass = ifelse(grepl(pattern = "high", x = eval(parse(text = params$TRIAD1)), ignore.case = TRUE), "high", ifelse(grepl(pattern = "moderate", x = eval(parse(text = params$TRIAD1)), ignore.case = TRUE), "moderate", "low")),
        type = NA
    ) %>%
    dplyr::filter(!is.na(params$TRIAD1))


vect_adop_tri$type[grepl(pattern = " AE", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = " EA", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "bio", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "SE", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "s"
vect_adop_tri$type[grepl(pattern = "soil", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "lowland", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = " temp", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = " elevation", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "market", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "s"
vect_adop_tri$type[grepl(pattern = "rain", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "SPAM presence", x = paste0("vect_adop_tri$",params$TRIAD1), ignore.case = TRUE)] <- "b"


vect_adop_tri %>%
    dplyr::select(params$TRIAD1, adopclass, type) %>%
    (knitr::kable) %>% kable_styling("striped", full_width = F) %>% scroll_box(height = "300px")
``` 
</div>

```{r i1_classified_adop_membership_maps03, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps04 , cache = TRUE, cache.whatever=params$Agg,  out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps05 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=adop_crit_i1}
...
if (params$RES1 != 2) {
  ...
  g2 +
    ...
    #geom_spatvector_text(data = vect_adop_tri,
...
```{r i1_classified_adop_membership_maps06, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps07 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_adop_3class_max2_geo <- project(vect_adop_3class_max2, wkt_geo)
...
```{r i1_classified_adop_membership_maps_fao01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps_fao02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=adop_crit_i1 }
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps_fao03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=adop_crit_i1}
...
```{r i1_classified_adop_membership_maps_fao04, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps_fao05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_adop_fao_cat4 <- merge(x = vect_adop_fao_cat3, y = vect_adop, by.x = "id.y", by.y = "id", all.x = TRUE)
     ...
     # project to geo for display in leaflet
  vect_adop_fao_cat4_geo <- project(vect_adop_fao_cat4, wkt_geo)
...
```{r i1_classified_adop_membership_maps_faolimits01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps_faolimits02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=adop_crit_i1 }
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps_faolimits03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=adop_crit_i1}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i1_classified_adop_membership_maps_faolimits04, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_adop_membership_maps_faolimits05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_adop_faolimits_cat4 <- merge(x = vect_adop_faolimits_cat3, y = vect_adop, by.x = "id.y", by.y = "id", all.x = TRUE)
     ...
     # project to geo for display in leaflet
  vect_adop_faolimits_cat4_geo <- project(vect_adop_faolimits_cat4, wkt_geo)
...
```{r i1_classified_ba_membership_maps01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps02 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}

# idem + overlay triangulation aptitude points

vect_ba_tri <- vect_triangulation %>%
    mutate(
        baclass = ifelse(grepl(pattern = "suboptimal", x = eval(parse(text = params$TRIBA1)), ignore.case = TRUE), "suboptimal", ifelse(grepl(pattern = "optimal", x = eval(parse(text = params$TRIBA1)), ignore.case = TRUE), "optimal", "other"))#,
        #type = NA  #a Farrow commented out 26/09/2023
    ) %>%
    dplyr::filter(!is.na(params$TRIBA1))

vect_ba_tri$type[grepl(pattern = " AE", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = " EA", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "bio", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "SE", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "s"
vect_ba_tri$type[grepl(pattern = "soil", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "lowland", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = " temp", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = " elevation", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "market", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "s"
vect_ba_tri$type[grepl(pattern = "rain", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "SPAM presence", x = paste0("vect_ba_tri$",params$TRIBA1), ignore.case = TRUE)] <- "b"

vect_ba_tri %>%
    dplyr::select(params$TRIBA1, baclass, type) %>%
    (knitr::kable) %>% kable_styling("striped", full_width = F) %>% scroll_box(height = "300px")
...
```{r i1_classified_ba_membership_maps_CRASA01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_CRASA02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
...
# project to geo for display in leaflet
  vect_ba_1class_bin_geo <- terra::project(vect_ba_1class_bin, wkt_geo)
...
rast_ba_1class_rcl_geo <- terra::project(rast_ba_1class_rcl, wkt_geo, method = "near")
...
```{r i1_classified_ba_membership_maps_CRASA03, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_CRASA04 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
...
```{r i1_classified_ba_membership_maps_opt01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_opt02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
# create classified aptitude map 
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_opt03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=ba_crit_i1}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i1_classified_ba_membership_maps_opt04, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_opt05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_ba_2class_max2 <- merge(x = vect_ba_2class_max2, y = vect_apt, by.x = "id.y", by.y = "id", all.x = TRUE)
     ...
     # project to geo for display in leaflet
  vect_ba_2class_max2_geo <- project(vect_ba_2class_max2, wkt_geo)
...
```{r i1_classified_ba_membership_maps_fao01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_fao02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
# create classified aptitude map 
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_fao03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=ba_crit_i1}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i1_classified_ba_membership_maps_fao04, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_fao05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_ba_fao_cat4 <- merge(x = vect_ba_fao_cat3, y = vect_apt, by.x = "id.y", by.y = "id", all.x = TRUE)
     ...
     # project to geo for display in leaflet
  vect_ba_fao_cat4_geo <- project(vect_ba_fao_cat4, wkt_geo)
...
```{r i1_classified_ba_membership_maps_faolimits01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_faolimits02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
# create classified aptitude map 
...
if (params$RES1 != 2) {
  ...
  df_irm_faolimits$limit <- names(df_irm_faolimits)[][max.col(df_irm_faolimits[])]
  
  df_irm_ba_faolimits <- cbind(df_irm_ba_fao, df_irm_faolimits)

  df_irm_ba_faolimits <- df_irm_ba_faolimits %>% 
  ...
  df_irm_faolimits_values  <-  df_irm_ba_faolimits %>% select(FAO_limit2) %>% unique()
  df_irm_faolimits_values  <- df_irm_faolimits_values[order(df_irm_faolimits_values$FAO_limit2), ] %>% data.frame
  names(df_irm_faolimits_values) <- c('FAO_limit_code')
  
  df_irm_faolimits_values  <- mutate(df_irm_faolimits_values, ID = row_number()-1)
  df_irm_faolimits_values  <- df_irm_faolimits_values[, c(2,1)] # re-order for later use as raster categories
  
  df_irm_faolimits_code <-
    data.frame(
      "FAO_code_num" = c(1:17),
      "FAO_code_char" = c(
        'S1',
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_faolimits03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=ba_crit_i1}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i1_classified_ba_membership_maps_faolimits04, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_ba_membership_maps_faolimits05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_apt[["id"]] <- 1:nrow(vect_apt) # need an id field for p-in-p matrix
  pinp_m <- relate(vect_ba_faolimits_cat2, vect_apt, "contains", pairs=TRUE) # point in polygon matrix
  df_pinp <- dplyr::as_tibble(pinp_m) # point in polygon tibble
  vect_ba_faolimits_cat3 <- merge(x = vect_ba_faolimits_cat2, y = df_pinp, by.x = "id", by.y = "id.x", all.x = TRUE)
  vect_ba_faolimits_cat4 <- merge(x = vect_ba_faolimits_cat3, y = vect_apt, by.x = "id.y", by.y = "id", all.x = TRUE)
  
     # project to geo for display in leaflet
  vect_ba_faolimits_cat4_geo <- project(vect_ba_faolimits_cat4, wkt_geo)
...
```{r i1_classified_se_membership_maps01, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_se_membership_maps02 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=sef_crit_i1}
# idem + overlay triangulation aptitude points
...
#vect_se_tri <- sfc_as_cols(vect_triangulation) %>%
  vect_se_tri <- vect_triangulation %>%
    mutate(
        seclass = ifelse(grepl(pattern = "high", x = eval(parse(text = params$TRISE1)), ignore.case = TRUE), "high", ifelse(grepl(pattern = "moderate", x = eval(parse(text = params$TRISE1)), ignore.case = TRUE), "moderate", "low")),
        type = NA
    ) %>%
    dplyr::filter(!is.na(params$TRISE1))


vect_se_tri$type[grepl(pattern = " AE", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = " EA", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "bio", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "SE", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "s"
vect_se_tri$type[grepl(pattern = "soil", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "lowland", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = " temp", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = " elevation", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "market", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "s"
vect_se_tri$type[grepl(pattern = "rain", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"

vect_se_tri %>%
    dplyr::select(params$TRISE1, seclass, type) %>%
    (knitr::kable) %>% kable_styling("striped", full_width = F) %>% scroll_box(height = "300px")

``` 
</div>

```{r i1_classified_se_membership_maps03, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_se_membership_maps04 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=sef_crit_i1}
...
if (sef_rb == "hml") {
  ...
  rast_se_3class_h <- rasterize(vect_se_3class, rast_mask_proj, field = "se_1_h")
  rast_se_3class_l <- rasterize(vect_se_3class, rast_mask_proj, field = "se_1_l")
  rast_se_3class <- rast(list(rast_se_3class_h, rast_se_3class_l))
...
<div class="fold o"> 
```{r i1_classified_se_membership_maps05 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=sef_crit_i1}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
g2 + 
    geom_spatvector(
        data = vect_se_tri, 
        mapping = aes(colour = ifelse(seclass == "high" , "green", "red")), 
        size = 1, shape = 21
    ) +
#    geom_spatvector_text(
#        data = vect_se_tri, 
...
```{r i1_classified_se_membership_maps06, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o"> 
```{r i1_classified_se_membership_maps07 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=sef_crit_i1}
...
if (params$RES1 != 2) {
  ...
  vect_se_3class_max2 <- merge(x = vect_se_3class_max2, y = vect_se, by.x = "id.y", by.y = "id", all.x = TRUE)
     ...
     # project to geo for display in leaflet
  vect_se_3class_max2_geo <- project(vect_se_3class_max2, wkt_geo)
...
```{r i1_statistics_adop_01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_adop_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i1}
...
```{r i1_statistics_adop_fao_01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_adop_fao_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i1}
...
```{r i1_statistics_adop_faolimits_01, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_adop_faolimits_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_adop_05, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_adop_06, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_adop_faolimits_03, echo=FALSE, results='asis', eval=adop_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_adop_faolimits_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i1}
# create subdiv level statistics
...
```{r i1_statistics_ba_01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_ba_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_ba_fao_01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_ba_fao_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_ba_faolimits_01, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_ba_faolimits_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_ba_03, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_ba_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_ba_faolimits_03, echo=FALSE, results='asis', eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_ba_faolimits_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_se_01, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_se_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=sef_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i1_statistics_se_03, echo=FALSE, results='asis', eval=sef_crit_i1}
...
<div class="fold o"> 
```{r i1_statistics_se_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=sef_crit_i1}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
<div class="fold o"> 
```{r i1_calc_yield_1, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", include = TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=ba_crit_i1}
...
<div class="fold o"> 
```{r i1_calc_yield_2, cache = TRUE, cache.whatever=params$Agg, out.width="100%", include = TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=ba_crit_i1}
...
<div class="fold o">
```{r i1_calc_yield_3, cache = TRUE, cache.whatever=params$Agg, out.width="100%", include = TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=ba_crit_i1}
...
if (("adop_0" %in% rbstacklist3) & ("ba_1" %in% rbstacklist3) & ("se_1" %in% rbstacklist3)){
    adop_crit_i2 <- TRUE
} else {adop_crit_i2 <- FALSE}


# biophysical aptitude rule base exists?
if ("ba_1" %in% rbstacklist3) {
    ba_crit_i2 <- TRUE
} else {ba_crit_i2 <- FALSE}

# agricultural land rule base exists?
if ("ba_2a" %in% rbnumberlist3) {
    land_crit_i2 <- TRUE
} else {land_crit_i2 <- FALSE}
...
if ("ba_2b" %in% rbstacklist3) {
    clim_crit_i2 <- TRUE
} else {clim_crit_i2 <- FALSE}

# soil physical properties rule base exists?
if ("ba_2c" %in% rbstacklist3) {
    soil_p_crit_i2 <- TRUE
  } else {soil_p_crit_i2 <- FALSE}

# soil fertility rule base exists?
if ("ba_2d" %in% rbstacklist3) {
    soil_f_crit_i2 <- TRUE
} else {soil_f_crit_i2 <- FALSE}

# landscape rule base exists?
if ("ba_2e" %in% rbstacklist3) {
    lscape_crit_i2 <- TRUE
} else {lscape_crit_i2 <- FALSE}

# rainfall rule base exists?
if ("ba_3a" %in% rbstacklist3) {
    prec_crit_i2 <- TRUE
} else {prec_crit_i2 <- FALSE}

# temperature rule base exists?
if ("ba_3b" %in% rbstacklist3) {
    tmp_crit_i2 <- TRUE
} else {tmp_crit_i2 <- FALSE}

# socio-economic feasibility rule base exists?
if ("se_1" %in% rbstacklist3) {
    sef_crit_i2 <- TRUE
} else {sef_crit_i2 <- FALSE}

# farm production feasibility rule base exists?
if ("se_2a" %in% rbstacklist3) {
    fpf_crit_i2 <- TRUE
} else {fpf_crit_i2 <- FALSE}

# market access rule base exists?
if ("se_2b" %in% rbstacklist3) {
    mktaccess_crit_i2 <- TRUE
} else {mktaccess_crit_i2 <- FALSE}

# management rule base exists?
if ("se_3a" %in% rbstacklist3) {
    management_crit_i2 <- TRUE
} else {management_crit_i2 <- FALSE}

# inputs access rule base exists?
if ("se_3b" %in% rbstacklist3) {
    inpaccess_crit_i2 <- TRUE
} else {inpaccess_crit_i2 <- FALSE}

# extension access rule base exists?
if ("se_4a" %in% rbstacklist3) {
    extaccess_crit_i2 <- TRUE
} else {extaccess_crit_i2 <- FALSE}

# labour access rule base exists?
if ("se_4b" %in% rbstacklist3) {
    lab_crit_i2 <- TRUE
} else {lab_crit_i2 <- FALSE}

# fertiliser/pesticides access rule base exists?
if ("se_4c" %in% rbstacklist3) {
    fp_crit_i2 <- TRUE
} else {fp_crit_i2 <- FALSE}
...
if (adop_crit_i2) {
  expr <- paste0("vect_triangulation$", params$TRIAD2)
  vect_triangulation$tri_label_ad <-
    paste(vect_triangulation$id, "=", eval(parse(text = (expr))))
  vect_triangulation$tri_label_ad <-
    factor(vect_triangulation$tri_label_ad)
...
if (ba_crit_i2) {
  expr <- paste0("vect_triangulation$", params$TRIBA2)
  vect_triangulation$tri_label_ba <-
    paste(vect_triangulation$id, "=", eval(parse(text = (expr))))
  vect_triangulation$tri_label_ba <-
    factor(vect_triangulation$tri_label_ba)
...
if (sef_crit_i2) {
  expr <- paste0("vect_triangulation$", params$TRISE2)
  vect_triangulation$tri_label_se <-
    paste(vect_triangulation$id, "=", eval(parse(text = (expr))))
  vect_triangulation$tri_label_se <-
    factor(vect_triangulation$tri_label_se)
...
```{r i2_requirements_ba01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
```{r i2_requirements_climatic01, echo=FALSE, results='asis', eval=clim_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_climatic02, results='asis', eval=clim_crit_i2}
...
```{r i2_requirements_climatic03, echo=FALSE, results='asis', eval=clim_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_phen_stages01, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2}
...
```{r i2_growth_stages01, echo=FALSE, results='asis'}
...
<div class="fold o"> 
```{r i2_growth_stages02, results='asis'}
...
<div class="fold o"> 
```{r i2_requirements_phen_stages_static01, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=nonsos_crit_i2}
...
<div class="fold o"> 
```{r i2_requirements_phen_stages_static02, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=nonsos_crit_i2}
...
```{r i2_requirements_sowing_dates_title, echo=FALSE, results='asis', eval=clim_crit_i2,  eval=sos_crit_i2}

cat("#### Spatially Dynamic Growing Seasons")

```

```{r i2_requirements_sowing_dates_intro, echo=FALSE, results='asis', eval=clim_crit_i2,  eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_onsetdata_01, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_onsetdata_02, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_onsetdata_03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_onsetdata_04, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_onsetdata_05, cache = TRUE, cache.whatever=params$Agg, out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_transpose, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_sowing_dates_sos_onsetdata_06, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">
```{r i2_sowing_dates_sos_maps_m, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">
```{r i2_sowing_dates_sos_maps_d, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_phen_stages01_sos_m, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_phen_stages01_sos_d, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=clim_crit_i2, eval=sos_crit_i2}
...
```{r i2_requirements_prec01, echo=FALSE, results='asis', eval=prec_crit_i2, eval=clim_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_prec02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=prec_crit_i2, eval=clim_crit_i2}
...
#        print(plot_raster)
        ...
        df_irm_i2 <- dplyr::select(df_irm_i2, -any_of(c(as.character(paste0(df_criteria_ba3a_m[crit_rownum, 3]))))) # remove column if name already exists
        
        df_irm_i2 <-
          mutate(df_irm_i2,!!as.character(paste0(df_criteria_ba3a_m[crit_rownum, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm_i2 tibble, this needs to be dynamic so uses the !! and := operators
...
#        print(plot_raster)
        ...
        df_irm_i2 <- dplyr::select(df_irm_i2, -any_of(c(as.character(paste0(df_criteria_ba3a_d[crit_rownum, 3]))))) # remove column if name already exists
        
        df_irm_i2 <-
          mutate(df_irm_i2,!!as.character(paste0(df_criteria_ba3a_d[crit_rownum, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm_i2 tibble, this needs to be dynamic so uses the !! and := operators
...
```{r i2_requirements_prec03, echo=FALSE, results='asis', eval=prec_crit_i2, eval=clim_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_prec04, cache = TRUE, cache.whatever=params$Agg, out.width="100%", fig.show="hold", warning=FALSE, eval=prec_crit_i2, eval=clim_crit_i2}
...
```{r i2_requirements_temp01, echo=FALSE, results='asis', eval=tmp_crit_i2, eval=clim_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_temp02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=temp_crit_i2, eval=clim_crit_i2}
  ...
  for (i in seq_len(nrow(df_criteria_ba3b_m))) {
    ...
    for (j in seq_len(nrow(df_growth_stages_req_temp))) {
      ...
      if (sum(df_criteria_ba3b_m[i, 'phen_stage'] == period_name, na.rm = TRUE) == 1) {
        ...
        df_irm_i2 <-  dplyr::select(df_irm_i2, -any_of(c(as.character(            paste0(df_criteria_ba3b_m[i, 3]))))) # remove column if name already exists
        
        df_irm_i2 <- mutate(df_irm_i2,!!as.character(paste0(df_criteria_ba3b_m[i, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm_i2 tibble, this needs to be dynamic so uses the !! and := operators
      } #-4
    }
  }
}
  ...
  for (i in seq_len(nrow(df_criteria_ba3b_d))) {
    ...
    for (j in seq_len(nrow(df_growth_stages_req_temp))) {
      ...
      if (sum(df_criteria_ba3b_d[i, 'phen_stage'] == period_name, na.rm = TRUE) == 1) {
        ...
        df_irm_i2 <-  dplyr::select(df_irm_i2, -any_of(c(as.character(            paste0(df_criteria_ba3b_d[i, 3]))))) # remove column if name already exists
        
        df_irm_i2 <- mutate(df_irm_i2,!!as.character(paste0(df_criteria_ba3b_d[i, 3])) := new_col, .keep = c("all"))   # add the raster values to the df_irm_i2 tibble, this needs to be dynamic so uses the !! and := operators
      } #-4
    }
  }
}
...
```{r i2_requirements_temp03, echo=FALSE, results='asis', eval=tmp_crit_i2, eval=clim_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_temp04, cache = TRUE, cache.whatever=params$Agg, out.width="100%", fig.show="hold", warning=FALSE, eval=tmp_crit_i2, eval=clim_crit_i2}
...
```{r i2_requirements_soilp01, echo=FALSE, results='asis', eval=soil_p_crit_i2}
...
```{r i2_requirements_soilp02, results='asis', warning=FALSE, eval=soil_p_crit_i2}
...
```{r i2_requirements_soilp03, echo=FALSE, results='asis', eval=soil_p_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_soilp04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_p_crit_i2}
...
```{r i2_requirements_soilp05, echo=FALSE, results='asis', eval=soil_p_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_soilp06, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_p_crit_i2}
...
```{r i2_requirements_soilf01, echo=FALSE, results='asis', eval=soil_f_crit_i2}
...
```{r i2_requirements_soilf02, results='asis', warning=FALSE, eval=soil_f_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_soilf03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_f_crit_i2}
...
```{r i2_requirements_soilf04, echo=FALSE, results='asis', eval=soil_f_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_soilf05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=soil_f_crit_i2}
...
```{r i2_requirements_lscape01, echo=FALSE, results='asis', eval=lscape_crit_i2}
...
```{r i2_requirements_lscape02, results='asis', warning=FALSE, eval=lscape_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_lscape03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lscape_crit_i2}
...
```{r i2_requirements_lscape04, echo=FALSE, results='asis', eval=lscape_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_lscape05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lscape_crit_i2}
...
```{r i2_requirements_agland01, echo=FALSE, results='asis', eval=land_crit_i2}

cat("### Agricultural Land requirements")

```

```{r i2_requirements_agland02, results='asis', warning=FALSE, eval=land_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_agland03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=land_crit_i2}
...
```{r i2_requirements_agland04, echo=FALSE, results='asis', eval=land_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_agland05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=land_crit_i2}
...
```{r i2_requirements_sef01, echo=FALSE, results='asis', eval=sef_crit_i2}
...
```{r i2_requirements_market_access01, echo=FALSE, results='asis', eval=mktaccess_crit_i2}

cat("### Market Access requirements")

```

```{r i2_requirements_market_access02, results='asis', warning=FALSE, eval=mktaccess_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_market_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=mktaccess_crit_i2}
...
```{r i2_requirements_market_access04, echo=FALSE, results='asis', eval=mktaccess_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_market_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=mktaccess_crit_i2}
...
```{r i2_requirements_inputs_access01, echo=FALSE, results='asis', eval=inpaccess_crit_i2}

cat("### Inputs Access requirements")

```

```{r i2_requirements_inputs_access02, results='asis', warning=FALSE, eval=inpaccess_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_inputs_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=inpaccess_crit_i2}
...
```{r i2_requirements_inputs_access04, echo=FALSE, results='asis', eval=inpaccess_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_inputs_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=inpaccess_crit_i2}
...
```{r i2_requirements_extension_access01, echo=FALSE, results='asis', eval=extaccess_crit_i2}
...
```{r i2_requirements_extension_access02, results='asis', warning=FALSE, eval=extaccess_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_extension_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=extaccess_crit_i2}
...
```{r i2_requirements_extension_access04, echo=FALSE, results='asis', eval=extaccess_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_extension_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=extaccess_crit_i2}
...
```{r i2_requirements_labour_access01, echo=FALSE, results='asis', eval=lab_crit_i2}

cat("### Labour requirements")

```

```{r i2_requirements_labour_access02, results='asis', warning=FALSE, eval=lab_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_labour_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lab_crit_i2}
...
```{r i2_requirements_labour_access04, echo=FALSE, results='asis', eval=lab_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_labour_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=lab_crit_i2}
...
```{r i2_requirements_fp_access01, echo=FALSE, results='asis', eval=fp_crit_i2}
...
```{r i2_requirements_fp_access02, results='asis', warning=FALSE, eval=fp_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_fp_access03, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=fp_crit_i2}
...
```{r i2_requirements_fp_access04, echo=FALSE, results='asis', eval=fp_crit_i2}
...
<div class="fold o">   
```{r i2_requirements_fp_access05, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", fig.show="hold", warning=FALSE, eval=fp_crit_i2}
...
```{r i2_rulebases_ba01, echo=FALSE, results='asis', eval=ba_crit_i2}
cat("## Bio-physical rule bases
...
```{r i2_rulebases_land01, echo=FALSE, results='asis', eval=land_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_land02, cache = TRUE, warning=FALSE, eval=land_crit_i2}
...
```{r i2_rulebases_clim01, echo=FALSE, results='asis', eval=clim_crit_i2}

cat("### Climatic rule bases")
```

```{r i2_rulebases_prec01, echo=FALSE, results='asis', eval=prec_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_prec02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=prec_crit_i2}
...
```{r i2_rulebases_tmp01, echo=FALSE, results='asis', eval=tmp_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_tmp02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=tmp_crit_i2}
...
```{r i2_rulebases_clim02, echo=FALSE, results='asis', eval=clim_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_clim03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=prec_crit_i2, eval=tmp_crit_i2}
...
```{r i2_rulebases_soilp01, echo=FALSE, results='asis', eval=soil_p_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_soilp02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=soil_p_crit_i2}
...
```{r i2_rulebases_soilf01, echo=FALSE, results='asis', eval=soil_f_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_soilf02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=soil_f_crit_i2}
...
```{r i2_rulebases_lscape01, echo=FALSE, results='asis', eval=lscape_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_lscape02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=lscape_crit_i2}
...
```{r i2_rulebases_ba02, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_ba03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=ba_crit_i2}
...
```{r i2_rulebases_ba_export01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o">
```{r i2_rulebases_ba_export02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=ba_crit_i2}
...
```{r i2_rulebases_sef01, echo=FALSE, results='asis', eval=sef_crit_i2}
...
```{r i2_rulebases_extension_access01, echo=FALSE, results='asis', eval=extaccess_crit_i2}
...
```{r i2_rulebases_extension_access02, echo=FALSE, results='asis', eval=extaccess_crit_i2}
...
```{r i2_rulebases_extension_access03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=extaccess_crit_i2}
...
```{r i2_rulebases_extension_access04, echo=FALSE, results='asis', eval=extaccess_crit_i2}
...
```{r i2_rulebases_extension_access05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=extaccess_crit_i2}
...
```{r i2_rulebases_extension_access06, echo=FALSE, results='asis', eval=extaccess_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_extension_access07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=extaccess_crit_i2}
...
```{r i2_rulebases_labour_access01, echo=FALSE, results='asis', eval=lab_crit_i2}
...
```{r i2_rulebases_labour_access02, echo=FALSE, results='asis', eval=lab_crit_i2}
...
```{r i2_rulebases_labour_access03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=lab_crit_i2}
...
```{r i2_rulebases_labour_access04, echo=FALSE, results='asis', eval=lab_crit_i2}
...
```{r i2_rulebases_labour_access05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=lab_crit_i2}
...
```{r i2_rulebases_labour_access06, echo=FALSE, results='asis', eval=lab_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_labour_access07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=lab_crit_i2}
...
```{r i2_rulebases_fp_access01, echo=FALSE, results='asis', eval=fp_crit_i2}
...
```{r i2_rulebases_fp_access02, echo=FALSE, results='asis', eval=fp_crit_i2}
...
```{r i2_rulebases_fp_access03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fp_crit_i2}
...
```{r i2_rulebases_fp_access04, echo=FALSE, results='asis', eval=fp_crit_i2}
...
```{r i2_rulebases_fp_access05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fp_crit_i2}
...
#Rule 2: If  F/P Access at Local Farmer Group is poor and F/P Access at woreda is good
rule2 <-   df_criteria_se5e$weight[1] - df_criteria_se5f$weight[1]

#Rule 3: If F/P Access at Local Farmer Group is good and F/P Access at woreda is poor
rule3 <-   -df_criteria_se5e$weight[1] + df_criteria_se5f$weight[1]
...
#Rule 2: then fp access is poor, moderate or good
if (rule2 >= 0.33)  {   # when local F/P has a higher weight
  fp_conclusion2 = "poor"
}     else if (rule2 > -0.33) { # when weights are similar
  fp_conclusion2 = "moderate"
} else {                # when woreda F/P has a higher weight
  fp_conclusion2 = "good"
}
cat(paste("rule 2 = ", fp_conclusion2))
cat("\n")
...
#Rule 3: then fp access is poor, moderate or good
if (rule3 >= 0.33)  { # when woreda F/P has a higher weight
  fp_conclusion3 = "poor"
}     else if (rule3 > -0.33) { # when weights are similar
  fp_conclusion3 = "moderate"
} else {
  fp_conclusion3 = "good" # when local F/P has a higher weight
}
cat(paste("rule 3 = ", fp_conclusion3))
cat("\n")
df_conc <- add_row(df_conc, se_4c = fp_conclusion3)

#Rule 4: then fp access is always poor
fp_conclusion4 = "poor"
cat(paste("rule 4 = ", fp_conclusion4))
df_conc <- add_row(df_conc, se_4c = fp_conclusion4)
...
```{r i2_rulebases_fp_access06, echo=FALSE, results='asis', eval=fp_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_fp_access07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=fp_crit_i2}
...
```{r i2_rulebases_farm_inputs01, echo=FALSE, results='asis', eval=inpaccess_crit_i2}
...
```{r i2_rulebases_farm_inputs02 , cache = TRUE, cache.whatever=params$Agg, results='asis', eval=inpaccess_crit_i2}
...
```{r i2_rulebases_farm_inputs03, echo=FALSE, results='asis', eval=inpaccess_crit_i2}
...
```{r i2_rulebases_farm_inputs04, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=inpaccess_crit_i2}
...
```{r i2_rulebases_farm_inputs05, echo=FALSE, results='asis', eval=inpaccess_crit_i2}
...
```{r i2_rulebases_farm_inputs06, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=inpaccess_crit_i2}
...
```{r i2_rulebases_farm_inputs07, echo=FALSE, results='asis', eval=inpaccess_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_farm_inputs08, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=inpaccess_crit_i2}

if (inpaccess_crit_i2 == 1) {
...
```{r i2_rulebases_management01, echo=FALSE, results='asis', eval=management_crit_i2}
...
```{r i2_rulebases_management02, results='asis', warning=FALSE, eval=management_crit_i2}
...
```{r i2_rulebases_management03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=management_crit_i2}
...
```{r i2_rulebases_management04, echo=FALSE, results='asis', eval=management_crit_i2}
...
```{r i2_rulebases_management05, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=management_crit_i2}
...
```{r i2_rulebases_management06, echo=FALSE, results='asis', eval=fp_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_management07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=management_crit_i2}
...
```{r i2_rulebases_fpf01, echo=FALSE, results='asis', eval=fpf_crit_i2}
...
```{r i2_rulebases_fpf02, results='asis', warning=FALSE, eval=fpf_crit_i2}
...
```{r i2_rulebases_fpf03, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fpf_crit_i2}
...
```{r i2_rulebases_fpf04, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=fpf_crit_i2}
...
```{r i2_rulebases_fpf05, echo=FALSE, results='asis', eval=fpf_crit_i2}
...
```{r i2_rulebases_fpf06, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=fpf_crit_i2}
...
```{r i2_rulebases_fpf07, echo=FALSE, results='asis', eval=fpf_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_fpf08, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=fpf_crit_i2}
...
if (mgt_rb == "gmp") {
  ...
  if (inp_rb == "gmp") {
    ...
    # there is a no moderate conclusion to inputs giving  six rules and conclusions
...
```{r i2_rulebases_market_access01, echo=FALSE, results='asis', eval=mktaccess_crit_i2}
...
```{r i2_rulebases_market_access02, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=mktaccess_crit_i2}
...
```{r i2_rulebases_market_access03, echo=FALSE, results='asis', eval=mktaccess_crit_i2}
...
```{r i2_rulebases_market_access04, cache = TRUE, cache.whatever=params$Agg, results='asis', eval=mktaccess_crit_i2}
...
```{r i2_rulebases_market_access05, echo=FALSE, results='asis', eval=mktaccess_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_market_access06, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=mktaccess_crit_i2}
...
```{r i2_rulebases_sef02, echo=FALSE, results='asis', eval=sef_crit_i2}
...
```{r i2_rulebases_sef03, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=sef_crit_i2}
...
```{r i2_rulebases_sef04, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=sef_crit_i2}
...
```{r i2_rulebases_sef05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=sef_crit_i2}
...
```{r i2_rulebases_sef06, echo=FALSE, results='asis', eval=sef_crit_i2}
...
```{r i2_rulebases_sef07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=sef_crit_i2}
...
```{r i2_rulebases_sef08, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_sef09, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=sef_crit_i2}
...
```{r i2_rulebases_sef_score01, echo=FALSE, results='asis', eval=sef_crit_i2, eval=adop_crit_i2}
...
<div class="fold o">
```{r i2_rulebases_sef_score02, echo=FALSE, results='asis', eval=sef_crit_i2, eval=adop_crit_i2}
...
```{r i2_rulebases_se_export01, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o">
```{r i2_rulebases_se_export02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=sef_crit_i2}
...
```{r i2_rulebases_adoption01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_adoption02, results='asis', warning=FALSE, eval=adop_crit_i2}
...
```{r i2_rulebases_adoption03, echo=FALSE, results='asis', eval=adop_crit_i2}

cat("Rule base ba_1 has the following conclusions:")

```

```{r i2_rulebases_adoption04, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=adop_crit_i2}
...
```{r i2_rulebases_adoption05, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, results='asis', eval=adop_crit_i2}
...
```{r i2_rulebases_adoption06, echo=FALSE, results='asis', eval=adop_crit_i2}
...
```{r i2_rulebases_adoption07, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=adop_crit_i2}
...
```{r i2_rulebases_adoption08, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_rulebases_adoption09, cache = TRUE, cache.whatever=params$Agg, results='asis', warning=FALSE, eval=adop_crit_i2}
...
```{r i2_rulebases_adop_export01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o">
```{r i2_rulebases_adop_export02, cache = TRUE, cache.whatever=params$Agg, cache.whatever=params$Agg, warning=FALSE, eval=adop_crit_i2}
...
```{r i2_classified_adop_membership_maps01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps02 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i2}
# idem + overlay triangulation adoption points

vect_adop_tri <- vect_triangulation %>%
    mutate(
        adopclass = ifelse(grepl(pattern = "high", x = eval(parse(text = params$TRIAD2)), ignore.case = TRUE), "high", ifelse(grepl(pattern = "moderate", x = eval(parse(text = params$TRIAD2)), ignore.case = TRUE), "moderate", "low")),
        type = NA
    ) %>%
    dplyr::filter(!is.na(params$TRIAD2))


vect_adop_tri$type[grepl(pattern = " AE", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = " EA", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "bio", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "SE", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "s"
vect_adop_tri$type[grepl(pattern = "soil", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "lowland", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = " temp", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = " elevation", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "market", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "s"
vect_adop_tri$type[grepl(pattern = "rain", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"
vect_adop_tri$type[grepl(pattern = "SPAM presence", x = paste0("vect_adop_tri$",params$TRIAD2), ignore.case = TRUE)] <- "b"


vect_adop_tri %>%
    dplyr::select(params$TRIAD2, adopclass, type) %>%
    (knitr::kable) %>% kable_styling("striped", full_width = F) %>% scroll_box(height = "300px")
``` 
</div>

```{r i2_classified_adop_membership_maps03, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps04 , cache = TRUE, cache.whatever=params$Agg,  out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=adop_crit_i2}
# create classified adoption map 
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps05 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=adop_crit_i2}
# create classified adoption map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_adop_membership_maps06, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps07 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i2}
...
```{r i2_classified_adop_membership_maps_fao01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps_fao02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=adop_crit_i2 }
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps_fao03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=adop_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_adop_membership_maps_fao04, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps_fao05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i2}
...
```{r i2_classified_adop_membership_maps_faolimits01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps_faolimits02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=adop_crit_i2 }
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps_faolimits03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=adop_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_adop_membership_maps_faolimits04, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_adop_membership_maps_faolimits05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=adop_crit_i2}
...
```{r i2_classified_ba_membership_maps01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps02 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}

# idem + overlay triangulation aptitude points

vect_ba_tri <- vect_triangulation %>%
    mutate(
        baclass = ifelse(grepl(pattern = "suboptimal", x = eval(parse(text = params$TRIBA2)), ignore.case = TRUE), "suboptimal", ifelse(grepl(pattern = "optimal", x = eval(parse(text = params$TRIBA2)), ignore.case = TRUE), "optimal", "other"))#,
        #type = NA  #a Farrow commented out 26/09/2023
    ) %>%
    dplyr::filter(!is.na(params$TRIBA2))

vect_ba_tri$type[grepl(pattern = " AE", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = " EA", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "bio", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "SE", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "s"
vect_ba_tri$type[grepl(pattern = "soil", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "lowland", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = " temp", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = " elevation", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "market", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "s"
vect_ba_tri$type[grepl(pattern = "rain", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"
vect_ba_tri$type[grepl(pattern = "SPAM presence", x = paste0("vect_ba_tri$",params$TRIBA2), ignore.case = TRUE)] <- "b"

vect_ba_tri %>%
    dplyr::select(params$TRIBA2, baclass, type) %>%
    (knitr::kable) %>% kable_styling("striped", full_width = F) %>% scroll_box(height = "300px")
...
```{r i2_classified_ba_membership_maps_CRASA01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_CRASA02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified aptitude map 
...
```{r i2_classified_ba_membership_maps_CRASA03, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_CRASA04 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
...
```{r i2_classified_ba_membership_maps_opt01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_opt02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified aptitude map 
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_opt03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_ba_membership_maps_opt04, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_opt05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
...
```{r i2_classified_ba_membership_maps_fao01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_fao02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified aptitude map 
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_fao03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_ba_membership_maps_fao04, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_fao05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
...
```{r i2_classified_ba_membership_maps_faolimits01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_faolimits02 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified aptitude map 
...
if (params$RES2 != 2) {
  ...
  df_irm_i2_faolimits$limit <- names(df_irm_i2_faolimits)[][max.col(df_irm_i2_faolimits[])]
  
  df_irm_i2_ba_faolimits <- cbind(df_irm_i2_ba_fao, df_irm_i2_faolimits)

  df_irm_i2_ba_faolimits <- df_irm_i2_ba_faolimits %>% 
      mutate(FAO_limit = case_match(limit, "ba_2b_s" ~ "Cl", "ba_2c_s" ~ "SP", "ba_2d_s" ~ "SF", "ba_2e_s" ~ "Ls",
  .default = "missing"), .keep = "all")
  ...
  df_irm_i2_faolimits_values  <-  df_irm_i2_ba_faolimits %>% select(FAO_limit2) %>% unique()
  df_irm_i2_faolimits_values  <- df_irm_i2_faolimits_values[order(df_irm_i2_faolimits_values$FAO_limit2), ] %>% data.frame
  names(df_irm_i2_faolimits_values) <- c('FAO_limit_code')
  
  df_irm_i2_faolimits_values  <- mutate(df_irm_i2_faolimits_values, ID = row_number()-1)
  df_irm_i2_faolimits_values  <- df_irm_i2_faolimits_values[, c(2,1)] # re-order for later use as raster categories
  
  df_irm_i2_faolimits_code <-
    data.frame(
      "FAO_code_num" = c(1:17),
      "FAO_code_char" = c(
        'S1',
  ...
  vect_ba_faolimits  <- vect(df_irm_i2_ba_faolimits, geom = c("x", "y"))
    
  rast_ba_faolimits <- rasterize(vect_ba_faolimits, rast_mask_proj, field = "FAO_limit2")
  names(rast_ba_faolimits) <- c('FAO_limit_code')
  levels(rast_ba_faolimits) <- df_irm_i2_faolimits_values
  
  vect_ba_faolimits <-    merge(
    x = vect_ba_faolimits,
    y = df_irm_i2_faolimits_code,
    by.x = "FAO_limit2",
    by.y = "FAO_code_char",
    all.x = TRUE
  )
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_faolimits03 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=ba_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_ba_membership_maps_faolimits04, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_ba_membership_maps_faolimits05 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
...
```{r i2_classified_se_membership_maps01, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_se_membership_maps02 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=sef_crit_i2}
# idem + overlay triangulation aptitude points
...
#vect_se_tri <- sfc_as_cols(vect_triangulation) %>%
  vect_se_tri <- vect_triangulation %>%
    mutate(
        seclass = ifelse(grepl(pattern = "high", x = eval(parse(text = params$TRISE2)), ignore.case = TRUE), "high", ifelse(grepl(pattern = "moderate", x = eval(parse(text = params$TRISE2)), ignore.case = TRUE), "moderate", "low")),
        type = NA
    ) %>%
    dplyr::filter(!is.na(params$TRISE2))


vect_se_tri$type[grepl(pattern = " AE", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = " EA", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "bio", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "SE", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "s"
vect_se_tri$type[grepl(pattern = "soil", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "lowland", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = " temp", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = " elevation", x = paste0("vect_adop_tri$",params$TRISE1), ignore.case = TRUE)] <- "b"
vect_se_tri$type[grepl(pattern = "market", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "s"
vect_se_tri$type[grepl(pattern = "rain", x = paste0("vect_adop_tri$",params$TRISE2), ignore.case = TRUE)] <- "b"

vect_se_tri %>%
    dplyr::select(params$TRISE2, seclass, type) %>%
    (knitr::kable) %>% kable_styling("striped", full_width = F) %>% scroll_box(height = "300px")
``` 
</div>

```{r i2_classified_se_membership_maps03, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_se_membership_maps04 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=sef_crit_i2}
# create classified feasibility map
...
<div class="fold o"> 
```{r i2_classified_se_membership_maps05 , cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE, eval=sef_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
...
```{r i2_classified_se_membership_maps06, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o"> 
```{r i2_classified_se_membership_maps07 , cache = TRUE, cache.whatever=params$Agg, warning=FALSE, timeit = TRUE, eval=sef_crit_i2}
...
```{r i2_statistics_adop_01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_adop_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i2}
...
```{r i2_statistics_adop_fao_01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_adop_fao_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_adop_faolimits_01, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_adop_faolimits_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_adop_05, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_adop_06, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_adop_faolimits_03, echo=FALSE, results='asis', eval=adop_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_adop_faolimits_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=adop_crit_i2}
# create subdiv level statistics
...
```{r i2_statistics_ba_01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_ba_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_ba_fao_01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_ba_fao_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_ba_faolimits_01, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_ba_faolimits_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_ba_03, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_ba_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_ba_faolimits_03, echo=FALSE, results='asis', eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_ba_faolimits_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=ba_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_se_01, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_se_02, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=sef_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
```{r i2_statistics_se_03, echo=FALSE, results='asis', eval=sef_crit_i2}
...
<div class="fold o"> 
```{r i2_statistics_se_04, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", warning=FALSE, eval=sef_crit_i2}
# create subdiv level statistics
# 03/03/2019 A FARROW adde
...
<div class="fold o"> 
```{r i2_calc_yield_1, cache = TRUE, cache.whatever=params$Agg,  out.width="100%", include = TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=ba_crit_i2}
...
<div class="fold o"> 
```{r i2_calc_yield_2, cache = TRUE, cache.whatever=params$Agg, out.width="100%", include = TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=ba_crit_i2}
...
if (params$INN2 == "NA") {
  df_irm_i2$yield <- df_irm_i2$yieldpc / 100 * df_yield_values$YW
  cat("Sole crop yield")
} else {
  if (params$SYS == "comparison") {
    df_irm_i2$yield <- df_irm_i2$yieldpc / 100 * df_yield_values$YW
...
<div class="fold o"> 
```{r i2_calc_yield_3, cache = TRUE, cache.whatever=params$Agg, out.width="100%", include = TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=ba_crit_i2}
...
## Alternative effect of socio-economic feasibility on biophysical aptitude

This is a special situation where an intervention has an effect on biophysical aptitude. We model this by changing the threshold of a particular biophysical criterion. The socio-economic feasibility shows where this effect takes place. This implies that we multiply the value of the biophysical aptitude optimality and the feasibility optimality. We then compare the resulting value with the original biophysical aptitude optimality, and select the highest value and produce classified maps.

<div class="fold o">
```{r classified compare_score_maps2, cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}

if (adop_crit_i1) {
  df_ba_se <-
    df_irm %>% dplyr::select(paste0(df_criteria_0[1, 3], "_o"),
                             paste0(df_criteria_0[2, 3], "_o"),
                             paste0(df_criteria_0[1, 3], "_s"),
                             paste0(df_criteria_0[2, 3], "_s"),
                             x ,
                             y) %>% na.omit
  
  # effect on ba optimality equals the product sum
  ...
  df_ba_se <-
    mutate(df_ba_se, ba_se_o := eval(expr_ba_se), .keep = c("all"))
  
  vect_ba_se <-
    df_ba_se  %>% vect(geom = c("x", "y")) # evaluate the product sum and convert to vect
  
  rast_ba_se <-
    rasterize(vect_ba_se, rast_mask_proj, field = "ba_se_o")
  
  
  rast_ba_max <-
    max(rast_ba_se, rast_ba_2class_o) # compare with ba optimality of second innovation and choose max value
  
  rast_ba_max_bin <-
    classify(rast_ba_max, m_ba_fao, include.lowest = TRUE)
  rast_ba_max_cat <- rast_ba_max_bin
  levels(rast_ba_max_cat) <- df_ba_fao
  rast_ba_max_brick <-
    rast(list(rast_ba_max, rast_ba_max_bin, rast_ba_max_cat))
  names(rast_ba_max_brick) <- c('optimal', 'bin', 'FAO')
  output_geotiff(rast_ba_max_brick,
                 paste0("1class_ba_max_", params$INN1, "_", params$INN2))
  
  # export class and optimal value as polygon
  vect_ba_max_cat <- as.polygons(rast_ba_max_cat, dissolve = T)
  
  vect_filename <-
    as.character(paste0("spatial_data/output/1class_ba_max_", params$INN1, "_", params$INN2, ".shp"))
  writeVector(vect_ba_max_cat, here(vect_filename), overwrite = TRUE)
  
  g <- ggplot() +
    geom_spatraster(data = rast_ba_max_cat, na.rm = TRUE, aes(fill = FAO)) +
    scale_fill_manual(
      name = paste0("FAO\nsuitability\nMax\n", params$INN1, "\n" , params$INN2),
      na.value = "transparent",
      values = c(
...
<div class="fold o"> 
```{r classified compare_score_maps3, cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}
...
We then need to compare the limitations. We use the previous assessment to see which of the two innovations has the higher suitability (taking into account the effect of socio-economic feasibility), and then get the criteria with the biggest limitation from the appropriate innovation.


<div class="fold o"> 
```{r classified compare_score_maps4, cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, timeit = TRUE, eval=ba_crit_i2}

if (adop_crit_i1) {
  
  # which of the innovations has the higher value
  # create the df with all the necessary data:
  # the ba_o of the original innovation
  # the ba_se_o of the adapted innovation
  # the limiting criteria of the adapted innovation
  # the FAO limit codes of the original innovation
  ...
  df_irm_ba_faolimits_rename <-
    df_irm_ba_faolimits %>% rename(irm_FAO_limit2 = FAO_limit2, )
  
  df_irm_i2_ba_faolimits_rename <-
    df_irm_i2_ba_faolimits %>% rename(irm_i2_FAO_limit2 = FAO_limit2)
  
  df_irm_compare_ba_faolimits <-
    cbind(
      select(
        df_ba_se_o,
        x,
      ...
      select(
        df_irm_i2_ba_faolimits_rename,
        paste0(df_criteria_0[1, 3], "_o"),
        irm_i2_FAO_limit2
      )
    )
  
  # re-calculate the suboptimality of soil fertility
  
  df_irm_compare_ba_faolimits <-
    mutate(
      df_irm_compare_ba_faolimits,
      ba_2d_s_se_i1 = (1 - ((1 - ba_2d_s_i1) * se_1_o_i1)),
      .keep = c("all")
    )
  
  # calculate the FAO suitability order 
  
  df_irm_compare_ba_faolimits$FAO_i1 <- 
    cut(df_irm_compare_ba_faolimits$ba_se_o_i1, breaks = c(0, 0.25, 0.4, 0.6, 0.85, 1), labels = c("N2", "N1", "S3", "S2", "S1"), right = TRUE, include.lowest = TRUE)
  
  
  # select the biophysical criteria that contribute to ba
  
  df_irm_compare_ba_faolimits_criteria <-
    df_irm_compare_ba_faolimits %>% dplyr::select(ba_2b_s_i1, ba_2c_s_i1,     ba_2d_s_se_i1,  ba_2e_s_i1) %>% na.omit
  
  
  # calculate the biophysical criteria that most limits ba
  
  df_irm_compare_ba_faolimits_criteria$limit_i1 <-
    names(df_irm_compare_ba_faolimits_criteria)[][max.col(df_irm_compare_ba_faolimits_criteria[])]

  
  # convert these criteria field names into label components
  
  df_irm_compare_ba_faolimits_criteria <- df_irm_compare_ba_faolimits_criteria %>%
    mutate(
      FAO_limit_i1 = case_match(
        limit_i1,
        "ba_2b_s_i1" ~ "Cl",
        "ba_2c_s_i1" ~ "SP",
        "ba_2d_s_se_i1" ~ "SF",
  ...
  # join the limits to the comparison table
  
  df_irm_compare_ba_faolimits <-
    cbind(
      df_irm_compare_ba_faolimits,
      select(df_irm_compare_ba_faolimits_criteria, FAO_limit_i1)
    )
  
  # concatenate the FAO suitability order and the limiting criteria
  
  df_irm_compare_ba_faolimits <- df_irm_compare_ba_faolimits %>%
    mutate(FAO_limit_label_i1 = case_when(FAO_i1 == "S1" ~ "S1", .default = paste0(FAO_i1, "_", FAO_limit_i1)))
    
  
  # select the label to use based on comparison of aptitude
  
  df_irm_compare_ba_faolimits$FAO_limit_label_max <-
    ifelse(
      df_irm_compare_ba_faolimits$ba_se_o > df_irm_compare_ba_faolimits$ba_1_o,
      df_irm_compare_ba_faolimits$FAO_limit_label_i1,
      df_irm_compare_ba_faolimits$irm_i2_FAO_limit2
    )
  

  # join to the FAO label - numeric code df
  
  df_irm_compare_ba_faolimits <-
    merge(
      x = df_irm_compare_ba_faolimits,
      y = df_irm_faolimits_code,
      by.x = "FAO_limit_label_max",
      by.y = "FAO_code_char",
      all.x = TRUE
    )
  ...
  vect_irm_compare_ba_faolimits <-
    df_irm_compare_ba_faolimits %>% vect(geom = c("x", "y")) 
    
  
  # convert to spatraster

  rast_irm_compare_ba_faolimits <-
    rasterize(vect_irm_compare_ba_faolimits, rast_mask_proj, field = "FAO_code_num")
  
  
   # add levels to spatraster 
  
  levels(rast_irm_compare_ba_faolimits) <- df_irm_faolimits_code
  
  # export the spatraster 
  
  output_geotiff(rast_irm_compare_ba_faolimits,
                 paste0("FAO_limits_ba_max_", params$INN1, "_", params$INN2))
 
  # plot the spatraster 
  
  g <- ggplot() +
    geom_spatraster(data = rast_irm_compare_ba_faolimits, na.rm = TRUE, aes(fill = FAO_code_char)) +
    scale_fill_manual(
      name = paste0("FAO\nlimitations\n", params$INN2),
      breaks = c(
        'S1',
...
<div class="fold o"> 
```{r classified compare_score_maps5, cache = TRUE, cache.whatever=params$Agg, out.width="100%", message=FALSE, warning=FALSE, message  = FALSE, timeit = TRUE,   eval=ba_crit_i2}
# create classified suitability map and validation
# 01/03/2019 A FARROW this chunk split because map not appearing
