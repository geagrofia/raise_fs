...
df_requirements_short_i1 <-
  df_requirements_i1 %>% select(stack, criterion, weight, threshold, threshold2,	width,	width2)
...
df_requirements_short_i1 <-
  df_requirements_i1 %>% select(rulebase_stack, rulebase_number, weight, threshold, threshold2,	width,	width2)
